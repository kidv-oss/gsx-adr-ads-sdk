 ...
 */
class AdmInterstitialAd internal constructor() : InterstitialAdEventCallback {
    ...
    private fun units(): List<String> = AdmConfigAdId.listInterstitialAdUnitID.filter { it.isNotBlank() }
