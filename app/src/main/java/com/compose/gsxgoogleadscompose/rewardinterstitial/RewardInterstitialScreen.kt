package com.compose.gsxgoogleadscompose.rewardinterstitial
...
import com.gsx.googleadcompose.GoogleAds.AdmRewardInterstitial

/** Màn test AdmRewardInterstitial: Load + Show (có thưởng). Instance riêng cho màn (tự destroy). */
@Composable
fun RewardInterstitialScreen() {
    ...
    Column(
        ...
        Text("Rewarded Interstitial", color = Color(0xFF52DE11), fontSize = 28.sp, fontWeight = FontWeight.W700)
        PremiumStatusText()
        Text(
            text = status,
            color = Color.White,
        ...
        Button(
            onClick = { status = "Đang load..."; ad.load(1) },
